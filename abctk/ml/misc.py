...
def create_mod_treebank(
    ...
    """
    logger.info(
        "Function `create_mod_treebank` called. "
        f"Treebank file: '{p_treebank}'; "
        f"Destination directory: '{dir_output}'; "
        f"Mode: {mode}."
    )
...
def generate_category(head: str, args: typing.Sequence[str], is_bracketed = False) -> str:
    if args:
